...
<body class="hold-transition layout-top-nav">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div hidden class="alert alert-secondary text-center not-support-offline" role="alert">
        <small>
          <i class="fas fa-exclamation-triangle"></i> &nbsp;
          Perangkat anda tidak mendukung mode luring
        </small>
      </div>
  ...
  <script type="text/javascript">
    (function() {
      if ('serviceWorker' in navigator) navigator.serviceWorker.register('<?= base_url('service-worker.js') ?>')
      else $('.not-support-offline').removeAttr('hidden')
    })()
  </script>
</body>
